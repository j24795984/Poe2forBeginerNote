...
When starting the dev server, use the npm development script in the foreground:

```
npm run dev
```

Do not use Astro's background-server mode or its background server management commands.
